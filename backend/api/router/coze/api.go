...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		}
		{
			...
			_thread_id := _threads.Group("/:thread_id", _thread_idMw()...)
			_thread_id.GET("/artifact_scan_jobs", append(_listcanonicalthreadartifactscanjobsMw(), coze.ListCanonicalThreadArtifactScanJobs)...)
			_artifact_scan_jobs := _thread_id.Group("/artifact_scan_jobs", _artifact_scan_jobsMw()...)
			{
			...
			_thread_id.GET("/artifacts", append(_listcanonicalthreadartifactsMw(), coze.ListCanonicalThreadArtifacts)...)
			...
			{
				_artifact_id0 := _artifacts.Group("/:artifact_id", _artifact_id0Mw()...)
				_artifact_id0.GET("/content", append(_getcanonicalthreadartifactcontentMw(), coze.GetCanonicalThreadArtifactContent)...)
				_artifact_id0.GET("/signed_url", append(_getcanonicalthreadartifactsignedurlMw(), coze.GetCanonicalThreadArtifactSignedURL)...)
			}
			_thread_id.GET("/guardrail_audit_events", append(_listcanonicalthreadguardrailauditeventsMw(), coze.ListCanonicalThreadGuardrailAuditEvents)...)
			_guardrail_audit_events := _thread_id.Group("/guardrail_audit_events", _guardrail_audit_eventsMw()...)
			_guardrail_audit_events.GET("/export", append(_exportcanonicalthreadguardrailauditeventsMw(), coze.ExportCanonicalThreadGuardrailAuditEvents)...)
			_thread_id.GET("/history", append(_getcanonicalthreadhistoryMw(), coze.GetCanonicalThreadHistory)...)
			_thread_id.POST("/history", append(_postcanonicalthreadhistoryMw(), coze.PostCanonicalThreadHistory)...)
			_thread_id.GET("/mcp_runtime_audit_events", append(_listcanonicalthreadmcpruntimeauditeventsMw(), coze.ListCanonicalThreadMCPRuntimeAuditEvents)...)
			_thread_id.GET("/memories", append(_listcanonicalthreadmemoriesMw(), coze.ListCanonicalThreadMemories)...)
			_memories := _thread_id.Group("/memories", _memoriesMw()...)
			_memories.GET("/audit_events", append(_listcanonicalthreadmemoryauditeventsMw(), coze.ListCanonicalThreadMemoryAuditEvents)...)
			_memories.POST("/clear", append(_clearcanonicalthreadmemoriesMw(), coze.ClearCanonicalThreadMemories)...)
			_memories.GET("/export", append(_exportcanonicalthreadmemoriesMw(), coze.ExportCanonicalThreadMemories)...)
			_memories.POST("/import", append(_importcanonicalthreadmemoriesMw(), coze.ImportCanonicalThreadMemories)...)
			_memories.DELETE("/:memory_id", append(_deletecanonicalthreadmemoryMw(), coze.DeleteCanonicalThreadMemory)...)
			_memory_id := _memories.Group("/:memory_id", _memory_idMw()...)
			_memory_id.POST("/restore", append(_restorecanonicalthreadmemoryMw(), coze.RestoreCanonicalThreadMemory)...)
			_memories.PUT("/:memory_id", append(_updatecanonicalthreadmemoryMw(), coze.UpdateCanonicalThreadMemory)...)
			_thread_id.GET("/messages", append(_listcanonicalthreadmessagesMw(), coze.ListCanonicalThreadMessages)...)
			_thread_id.POST("/messages", append(_appendcanonicalthreadmessageMw(), coze.AppendCanonicalThreadMessage)...)
			_thread_id.GET("/runs", append(_listcanonicalrunsMw(), coze.ListCanonicalRuns)...)
			_runs := _thread_id.Group("/runs", _runsMw()...)
			_runs.GET("/:run_id", append(_getcanonicalrunMw(), coze.GetCanonicalRun)...)
			...
			_thread_id.GET("/state", append(_getcanonicalthreadstateMw(), coze.GetCanonicalThreadState)...)
			_thread_id.POST("/state", append(_updatecanonicalthreadstateMw(), coze.UpdateCanonicalThreadState)...)
			_thread_id.POST("/suggestions", append(_generatecanonicalthreadsuggestionsMw(), coze.GenerateCanonicalThreadSuggestions)...)
			_thread_id.GET("/token_usage", append(_getcanonicalthreadtokenusageMw(), coze.GetCanonicalThreadTokenUsage)...)
			_thread_id.GET("/uploads", append(_listcanonicalthreaduploadsMw(), coze.ListCanonicalThreadUploads)...)
			_uploads := _thread_id.Group("/uploads", _uploadsMw()...)
