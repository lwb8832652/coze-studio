...
require_literal '-e WORKSPACE=/mnt/user-data'
...
require_literal '--mount "type=volume,src=$volume_name,dst=/mnt/user-data"'
require_literal 'assert mounts[0]["Destination"] == "/mnt/user-data"'
require_literal 'docker volume rm "$volume_name"'
