...
export interface ShortcutCommandToolInfo {
  ...
  workflow_id?: string,
  params?: ShortcutToolParam[],
}
export type ShortcutSendType = string;
export const ShortcutSendTypeQuery = "query";
export const ShortcutSendTypePanel = "panel";
