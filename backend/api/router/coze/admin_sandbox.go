...
func registerAdminSandboxTrailingSlashRoutes(admin *route.RouterGroup) {
	...
	admin.GET("/sandboxes/session-settings/", handler.RejectAdminSandboxTrailingSlash)
	admin.PUT("/sandboxes/session-settings/", handler.RejectAdminSandboxTrailingSlash)
	admin.GET("/sandboxes/session-runtime-status/", handler.RejectAdminSandboxTrailingSlash)
