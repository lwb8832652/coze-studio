...
func TestSessionExecRequestEnforcesCommandEnvironmentAndResourceBoundaries(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "uploads cwd", mutate: func(req *ExecRequest) { req.CWD = "/mnt/user-data/uploads" }},
		{name: "outputs cwd", mutate: func(req *ExecRequest) { req.CWD = "/mnt/user-data/outputs/job" }},
		{name: "skills cwd", mutate: func(req *ExecRequest) { req.CWD = "/mnt/skills/tool" }},
