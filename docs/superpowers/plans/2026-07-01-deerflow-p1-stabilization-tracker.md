...
| P1-I-006 Memory UI/API smoke | 进行中 | Browser and API evidence show memory management and runtime recall/update agree; unsafe prompt/completion/tool payloads stay hidden. Next: use the runtime-written memory row from task `7657481311426183168` to verify task memory API/UI list, edit/delete/restore, and export/import smoke without exposing raw transcript/provider/tool payloads. |
...
- Finish P1-I-006 memory UI/API smoke using the runtime-written memory from
  task `7657481311426183168`.
