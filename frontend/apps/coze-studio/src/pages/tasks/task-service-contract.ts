...
export type ListTaskThreadsRequest =
  PageSpace<SearchWorkbenchThreadsRequest>;
export type CreateTaskThreadRequest =
  PageSpace<CreateWorkbenchThreadRequest>;
...
export type GenerateTaskThreadSuggestionsRequest = PageSpace<
  GenerateWorkbenchSuggestionsRequest
>;
export type AppendTaskThreadMessageRequest = PageSpace<
  AppendWorkbenchMessageRequest
>;
export type ListTaskThreadRunsRequest =
  PageSpace<ListWorkbenchRunsRequest>;
export type CreateTaskThreadRunRequest =
  PageSpace<CreateWorkbenchRunRequest>;
export type ResumeTaskThreadRunRequest =
  PageSpace<ResumeWorkbenchRunRequest>;
export type CancelTaskThreadRunRequest =
  PageSpace<CancelWorkbenchRunRequest>;
export type RetryTaskThreadSubagentRunRequest = PageSpace<
  RetryWorkbenchSubagentRunRequest
>;
