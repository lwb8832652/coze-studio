...
- Continue scan/delete/restore lifecycle evidence from fixture task
  `7657556998191316992`: blocked review, retry, delete, restore, and
  copy/download affordance checks.
