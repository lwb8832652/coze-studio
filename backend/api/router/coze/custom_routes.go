...
func registerAdminCustomRoutes(api *route.RouterGroup) {
	...
	admin.GET("/sandboxes/scheduler-settings", sandbox.SchedulerSettings)
	admin.PUT("/sandboxes/scheduler-settings", sandbox.UpdateSchedulerSettings)
	admin.GET("/sandboxes/runtime-status", sandbox.RuntimeStatus)
	admin.GET("/sandboxes/session-settings", sandbox.SessionSettings)
	admin.PUT("/sandboxes/session-settings", sandbox.UpdateSessionSettings)
	admin.GET("/sandboxes/session-runtime-status", sandbox.SessionRuntimeStatus)
