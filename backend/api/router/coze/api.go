...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		_api.PATCH("/threads/:thread_id", coze.PatchLangGraphThread)
		_api.DELETE("/threads/:thread_id", coze.DeleteLangGraphThread)
		...
		_api.POST("/runs/wait", coze.WaitLangGraphStatelessRun)
		_runs := _api.Group("/runs")
		_runs.GET("/:run_id", coze.GetLangGraphStatelessRun)
		_runs.GET("/:run_id/messages", coze.ListLangGraphStatelessRunMessages)
		_runs.GET("/:run_id/feedback", coze.ListLangGraphStatelessRunFeedback)
		_runs.POST("/:run_id/cancel", coze.CancelLangGraphStatelessRun)
		_runs.GET("/:run_id/stream", coze.StreamLangGraphStatelessRun)
		_runs.POST("/:run_id/join", coze.JoinLangGraphStatelessRun)
		_runs.GET("/:run_id/join", coze.JoinLangGraphStatelessRunStream)
		_threads := _api.Group("/threads")
		_threads.GET("/:thread_id/state", coze.GetLangGraphThreadState)
		_threads.POST("/:thread_id/state", coze.PostLangGraphThreadState)
		_threads.GET("/:thread_id/history", coze.GetLangGraphThreadHistory)
		_threads.POST("/:thread_id/history", coze.PostLangGraphThreadHistory)
		_threads.GET("/:thread_id/checkpoints/:checkpoint_id/resume", coze.GetLangGraphCheckpointResumeReadiness)
		_threads.GET("/:thread_id/messages", coze.ListLangGraphThreadMessages)
		_threads.POST("/:thread_id/runs", coze.CreateLangGraphRun)
		_threads.POST("/:thread_id/runs/stream", coze.CreateLangGraphRunStream)
		_threads.POST("/:thread_id/runs/wait", coze.WaitLangGraphRun)
		...
		_threads.GET("/:thread_id/runs/:run_id/stream", coze.StreamLangGraphRun)
		_threads.POST("/:thread_id/runs/:run_id/stream", coze.StreamLangGraphRun)
		_threads.GET("/:thread_id/runs/:run_id/messages", coze.ListLangGraphRunMessages)
		_threads.GET("/:thread_id/runs/:run_id/events", coze.ListLangGraphRunEvents)
		_threads.POST("/:thread_id/runs/:run_id/join", coze.JoinLangGraphRun)
		_threads.GET("/:thread_id/runs/:run_id/join", coze.JoinLangGraphRunStream)
		{
			...
			_skill_id.PUT("/versions/:version_id/resources", append(_updateskillversionresourceMw(), coze.UpdateSkillVersionResource)...)
			_skill_id.PUT("/versions/:version_id/content", append(_updateskillversioncontentMw(), coze.UpdateSkillVersionContent)...)
			_skill_id.GET("/versions/:version_id/export", append(_exportskillversionMw(), coze.ExportSkillVersion)...)
			_skill_id.POST("/versions/:version_id/rollback", append(_rollbackskillversionMw(), coze.RollbackSkillVersion)...)
			...
			_mcp_tools := _workbench.Group("/mcp_tools")
			_mcp_tools.GET("/:server_id", coze.GetMCPToolServer)
			_mcp_tools.DELETE("/:server_id", coze.DeleteMCPToolServer)
			_mcp_tools.POST("/:server_id/test_call", coze.TestMCPToolCall)
			_mcp_tools.POST("/:server_id/discover", coze.DiscoverMCPToolServer)
			_mcp_tools.GET("/:server_id/export", coze.ExportMCPToolServer)
			_mcp_tools.GET("/:server_id/audit_events", coze.ListMCPToolAuditEvents)
			...
			_scheduled_tasks := _workbench.Group("/scheduled_tasks")
			...
			_task_threads.GET("/:thread_id/uploads", coze.ListTaskThreadUploadFiles)
			_task_threads.POST("/:thread_id/uploads", coze.UploadTaskThreadFiles)
			...
			_task_threads.GET("/:thread_id/memories", coze.ListTaskThreadMemories)
			_task_threads.GET("/:thread_id/memories/export", coze.ExportTaskThreadMemories)
			_task_threads.POST("/:thread_id/memories/import", coze.ImportTaskThreadMemories)
			_task_threads.GET("/:thread_id/memories/audit_events", coze.ListTaskThreadMemoryAuditEvents)
			_task_threads.GET("/:thread_id/guardrail_audit_events", coze.ListTaskThreadGuardrailAuditEvents)
			_task_threads.GET("/:thread_id/guardrail_audit_events/export", coze.ExportTaskThreadGuardrailAuditEvents)
			_task_threads.GET("/:thread_id/mcp_runtime_audit_events", coze.ListTaskThreadMCPRuntimeAuditEvents)
			_task_threads.POST("/:thread_id/memories/clear", coze.ClearTaskThreadMemories)
			_task_threads.POST("/:thread_id/memories/:memory_id/restore", coze.RestoreTaskThreadMemory)
			_task_threads.PUT("/:thread_id/memories/:memory_id", coze.UpdateTaskThreadMemory)
			_task_threads.DELETE("/:thread_id/memories/:memory_id", coze.DeleteTaskThreadMemory)
			_task_threads.GET("/:thread_id/artifacts", coze.ListTaskThreadArtifacts)
			_task_threads.GET("/:thread_id/artifact_scan_jobs", coze.ListTaskThreadArtifactScanJobs)
			_task_threads.POST("/:thread_id/artifact_scan_jobs/:job_id/retry", coze.RetryTaskThreadArtifactScanJob)
			_task_threads.POST("/:thread_id/artifacts/:artifact_id/scan_review", coze.ReviewTaskThreadArtifactScan)
			_task_threads.DELETE("/:thread_id/artifacts/:artifact_id", coze.DeleteTaskThreadArtifact)
			_task_threads.POST("/:thread_id/artifacts/:artifact_id/restore", coze.RestoreTaskThreadArtifact)
			_task_threads.GET("/:thread_id/artifacts/:artifact_id/signed_url", coze.GetTaskThreadArtifactSignedURL)
			_task_threads.GET("/:thread_id/artifacts/:artifact_id/content", coze.GetTaskThreadArtifactContent)
