...
type BotSpaceV2 struct {
	...
	AllowDevelop bool `thrift:"allow_develop,22" form:"allow_develop" json:"allow_develop" query:"allow_develop"`
	// Whether the workspace accepts published resources.
	ReceivePublish bool `thrift:"receive_publish,23" form:"receive_publish" json:"receive_publish" query:"receive_publish"`
}
...
func (p *BotSpaceV2) GetAllowDevelop() (v bool) {
	return p.AllowDevelop
}

func (p *BotSpaceV2) GetReceivePublish() (v bool) {
	return p.ReceivePublish
}
...
func (p *BotSpaceV2) ReadField22(iprot thrift.TProtocol) error {
	...
	p.AllowDevelop = _field
	return nil
}
func (p *BotSpaceV2) ReadField23(iprot thrift.TProtocol) error {
...
func (p *BotSpaceV2) writeField22(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("allow_develop", thrift.BOOL, 22); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteBool(p.AllowDevelop); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *BotSpaceV2) writeField23(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("receive_publish", thrift.BOOL, 23); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteBool(p.ReceivePublish); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
