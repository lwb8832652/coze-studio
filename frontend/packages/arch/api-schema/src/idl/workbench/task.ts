...
export interface TaskThreadUploadFile {
  file_id: string,
  filename: string,
  path: string,
  virtual_path: string,
...
export interface ListTaskThreadUploadFilesRequest {
  thread_id: string,
  space_id?: string,
}
export interface UploadTaskThreadFilesRequest {
  thread_id: string,
  space_id?: string,
}
export interface DeleteTaskThreadUploadFileRequest {
  thread_id: string,
  filename: string,
  space_id?: string,
}
export interface UploadTaskThreadFilesData {
  success: boolean,
  files: TaskThreadUploadFile[],
  message: string,
  skipped_files: string[],
}
export interface ListTaskThreadUploadFilesData {
  files: TaskThreadUploadFile[],
  count: number,
}
export interface DeleteTaskThreadUploadFileData {
  deleted: boolean,
  file?: TaskThreadUploadFile,
}
export interface UploadTaskThreadFilesResponse {
  data?: UploadTaskThreadFilesData,
  code: number,
  msg: string,
}
export interface ListTaskThreadUploadFilesResponse {
  data?: ListTaskThreadUploadFilesData,
  code: number,
  msg: string,
}
export interface DeleteTaskThreadUploadFileResponse {
  data?: DeleteTaskThreadUploadFileData,
  code: number,
  msg: string,
}
...
export const CreateTaskThread = /*#__PURE__*/createAPI<CreateTaskThreadRequest, CreateTaskThreadResponse>({
  "url": "/api/workbench/task_threads",
  "method": "POST",
  "name": "CreateTaskThread",
  "reqType": "CreateTaskThreadRequest",
  "reqMapping": {
    "body": ["space_id", "message", "title", "assistant_id", "command", "config", "context", "metadata", "stream_mode", "multitask_strategy", "on_disconnect", "durability", "idempotency_key", "defer_start"]
  },
...
export const GenerateTaskThreadSuggestions = /*#__PURE__*/createAPI<GenerateTaskThreadSuggestionsRequest, GenerateTaskThreadSuggestionsResponse>({
  ...
  "reqMapping": {
    "path": ["thread_id"],
    "body": ["messages", "n", "model_name", "model_type"]
  },
...
export const ListTaskThreadMemories = /*#__PURE__*/createAPI<ListTaskThreadMemoriesRequest, ListTaskThreadMemoriesResponse>({
  ...
  "reqMapping": {
    "path": ["thread_id"],
    "query": ["run_id", "scope", "scopes", "q", "include_expired", "include_deleted", "page", "page_size"]
  },
  "resType": "ListTaskThreadMemoriesResponse",
  "schemaRoot": "api://schemas/idl_workbench_task",
  "service": "workbenchTask"
});
export const ExportTaskThreadMemories = /*#__PURE__*/createAPI<ExportTaskThreadMemoriesRequest, ExportTaskThreadMemoriesResponse>({
...
export const ImportTaskThreadMemories = /*#__PURE__*/createAPI<ImportTaskThreadMemoriesRequest, ImportTaskThreadMemoriesResponse>({
...
export const UpdateTaskThreadMemory = /*#__PURE__*/createAPI<UpdateTaskThreadMemoryRequest, UpdateTaskThreadMemoryResponse>({
...
export const DeleteTaskThreadMemory = /*#__PURE__*/createAPI<DeleteTaskThreadMemoryRequest, DeleteTaskThreadMemoryResponse>({
  "url": "/api/workbench/task_threads/:thread_id/memories/:memory_id",
  "method": "DELETE",
...
export const ClearTaskThreadMemories = /*#__PURE__*/createAPI<ClearTaskThreadMemoriesRequest, ClearTaskThreadMemoriesResponse>({
...
export const RestoreTaskThreadMemory = /*#__PURE__*/createAPI<RestoreTaskThreadMemoryRequest, RestoreTaskThreadMemoryResponse>({
...
export const ListTaskThreadMemoryAuditEvents = /*#__PURE__*/createAPI<ListTaskThreadMemoryAuditEventsRequest, ListTaskThreadMemoryAuditEventsResponse>({
...
export const ListTaskThreadGuardrailAuditEvents = /*#__PURE__*/createAPI<ListTaskThreadGuardrailAuditEventsRequest, ListTaskThreadGuardrailAuditEventsResponse>({
...
export const ExportTaskThreadGuardrailAuditEvents = /*#__PURE__*/createAPI<ExportTaskThreadGuardrailAuditEventsRequest, ExportTaskThreadGuardrailAuditEventsResponse>({
...
export const ListTaskThreadMCPRuntimeAuditEvents = /*#__PURE__*/createAPI<ListTaskThreadMCPRuntimeAuditEventsRequest, ListTaskThreadMCPRuntimeAuditEventsResponse>({
...
export const ListTaskThreadArtifacts = /*#__PURE__*/createAPI<ListTaskThreadArtifactsRequest, ListTaskThreadArtifactsResponse>({
...
export const GetTaskThreadArtifactSignedURL = /*#__PURE__*/createAPI<GetTaskThreadArtifactSignedURLRequest, GetTaskThreadArtifactSignedURLResponse>({
...
export const CreateTaskThreadRun = /*#__PURE__*/createAPI<CreateTaskThreadRunRequest, CreateTaskThreadRunResponse>({
  ...
  "reqMapping": {
    "path": ["thread_id"],
    "body": ["assistant_id", "command", "input", "config", "context", "metadata", "stream_mode", "multitask_strategy", "on_disconnect", "durability", "idempotency_key", "message_content", "message_metadata"]
  },
  "resType": "CreateTaskThreadRunResponse",
  "schemaRoot": "api://schemas/idl_workbench_task",
  "service": "workbenchTask"
});
export const ResumeTaskThreadRun = /*#__PURE__*/createAPI<ResumeTaskThreadRunRequest, ResumeTaskThreadRunResponse>({
...
export const CancelTaskThreadRun = /*#__PURE__*/createAPI<CancelTaskThreadRunRequest, CancelTaskThreadRunResponse>({
...
export const RetryTaskThreadSubagentRun = /*#__PURE__*/createAPI<RetryTaskThreadSubagentRunRequest, RetryTaskThreadSubagentRunResponse>({
