...
import (
	...
	"github.com/coze-dev/coze-studio/backend/api/model/appdev"
...
type WorkbenchChatService interface {
	chat.WorkbenchChatService
}

type WorkbenchChatServiceClient struct {
	*chat.WorkbenchChatServiceClient
}
...
func NewWorkbenchChatServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *WorkbenchChatServiceClient {
	return &WorkbenchChatServiceClient{
		WorkbenchChatServiceClient: chat.NewWorkbenchChatServiceClientFactory(t, f),
	}
}
...
func NewWorkbenchChatServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *WorkbenchChatServiceClient {
	return &WorkbenchChatServiceClient{
		WorkbenchChatServiceClient: chat.NewWorkbenchChatServiceClientProtocol(t, iprot, oprot),
	}
}

func NewWorkbenchChatServiceClient(c thrift.TClient) *WorkbenchChatServiceClient {
	return &WorkbenchChatServiceClient{
		WorkbenchChatServiceClient: chat.NewWorkbenchChatServiceClient(c),
	}
}

type WorkbenchSkillService interface {
	skill.WorkbenchSkillService
}

type WorkbenchSkillServiceClient struct {
	*skill.WorkbenchSkillServiceClient
}
...
func NewWorkbenchSkillServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *WorkbenchSkillServiceClient {
	return &WorkbenchSkillServiceClient{
		WorkbenchSkillServiceClient: skill.NewWorkbenchSkillServiceClientFactory(t, f),
	}
}
...
func NewWorkbenchSkillServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *WorkbenchSkillServiceClient {
	return &WorkbenchSkillServiceClient{
		WorkbenchSkillServiceClient: skill.NewWorkbenchSkillServiceClientProtocol(t, iprot, oprot),
	}
}

func NewWorkbenchSkillServiceClient(c thrift.TClient) *WorkbenchSkillServiceClient {
	return &WorkbenchSkillServiceClient{
		WorkbenchSkillServiceClient: skill.NewWorkbenchSkillServiceClient(c),
	}
}

type WorkbenchTaskService interface {
	chat.WorkbenchTaskService
}

type WorkbenchTaskServiceClient struct {
	*chat.WorkbenchTaskServiceClient
}
...
func NewWorkbenchTaskServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *WorkbenchTaskServiceClient {
	return &WorkbenchTaskServiceClient{
		WorkbenchTaskServiceClient: chat.NewWorkbenchTaskServiceClientFactory(t, f),
	}
}
...
func NewWorkbenchTaskServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *WorkbenchTaskServiceClient {
	return &WorkbenchTaskServiceClient{
		WorkbenchTaskServiceClient: chat.NewWorkbenchTaskServiceClientProtocol(t, iprot, oprot),
	}
}

func NewWorkbenchTaskServiceClient(c thrift.TClient) *WorkbenchTaskServiceClient {
	return &WorkbenchTaskServiceClient{
		WorkbenchTaskServiceClient: chat.NewWorkbenchTaskServiceClient(c),
	}
}
...
func NewAppDevServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *AppDevServiceClient {
	return &AppDevServiceClient{
		AppDevServiceClient: appdev.NewAppDevServiceClientFactory(t, f),
	}
}
...
func NewAppDevServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *AppDevServiceClient {
	return &AppDevServiceClient{
		AppDevServiceClient: appdev.NewAppDevServiceClientProtocol(t, iprot, oprot),
	}
}

func NewAppDevServiceClient(c thrift.TClient) *AppDevServiceClient {
	return &AppDevServiceClient{
		AppDevServiceClient: appdev.NewAppDevServiceClient(c),
	}
}
...
type AppDevServiceProcessor struct {
	*appdev.AppDevServiceProcessor
}

func NewAppDevServiceProcessor(handler AppDevService) *AppDevServiceProcessor {
	self := &AppDevServiceProcessor{appdev.NewAppDevServiceProcessor(handler)}
	return self
}
