...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		}
		{
			...
			_thread_id0.GET("/artifact_scan_jobs", append(_listcanonicalthreadartifactscanjobsMw(), coze.ListCanonicalThreadArtifactScanJobs)...)
			_artifact_scan_jobs := _thread_id0.Group("/artifact_scan_jobs", _artifact_scan_jobsMw()...)
			{
				_job_id := _artifact_scan_jobs.Group("/:job_id", _job_idMw()...)
				_job_id.POST("/retry", append(_retrycanonicalthreadartifactscanjobMw(), coze.RetryCanonicalThreadArtifactScanJob)...)
			}
			_thread_id0.GET("/artifacts", append(_listcanonicalthreadartifactsMw(), coze.ListCanonicalThreadArtifacts)...)
			_artifacts0 := _thread_id0.Group("/artifacts", _artifacts0Mw()...)
			_artifacts0.DELETE("/:artifact_id", append(_deletecanonicalthreadartifactMw(), coze.DeleteCanonicalThreadArtifact)...)
			_artifact_id0 := _artifacts0.Group("/:artifact_id", _artifact_id0Mw()...)
			_artifact_id0.POST("/restore", append(_restorecanonicalthreadartifactMw(), coze.RestoreCanonicalThreadArtifact)...)
			_artifact_id0.POST("/scan_review", append(_reviewcanonicalthreadartifactscanMw(), coze.ReviewCanonicalThreadArtifactScan)...)
			{
				_artifact_id1 := _artifacts0.Group("/:artifact_id", _artifact_id1Mw()...)
				_artifact_id1.GET("/content", append(_getcanonicalthreadartifactcontentMw(), coze.GetCanonicalThreadArtifactContent)...)
				_artifact_id1.GET("/signed_url", append(_getcanonicalthreadartifactsignedurlMw(), coze.GetCanonicalThreadArtifactSignedURL)...)
			}
			_thread_id0.GET("/guardrail_audit_events", append(_listcanonicalthreadguardrailauditeventsMw(), coze.ListCanonicalThreadGuardrailAuditEvents)...)
			_guardrail_audit_events0 := _thread_id0.Group("/guardrail_audit_events", _guardrail_audit_events0Mw()...)
			_guardrail_audit_events0.GET("/export", append(_exportcanonicalthreadguardrailauditeventsMw(), coze.ExportCanonicalThreadGuardrailAuditEvents)...)
			...
			_thread_id0.GET("/mcp_runtime_audit_events", append(_listcanonicalthreadmcpruntimeauditeventsMw(), coze.ListCanonicalThreadMCPRuntimeAuditEvents)...)
			_thread_id0.GET("/memories", append(_listcanonicalthreadmemoriesMw(), coze.ListCanonicalThreadMemories)...)
			_memories0 := _thread_id0.Group("/memories", _memories0Mw()...)
			_memories0.GET("/audit_events", append(_listcanonicalthreadmemoryauditeventsMw(), coze.ListCanonicalThreadMemoryAuditEvents)...)
			_memories0.POST("/clear", append(_clearcanonicalthreadmemoriesMw(), coze.ClearCanonicalThreadMemories)...)
			_memories0.GET("/export", append(_exportcanonicalthreadmemoriesMw(), coze.ExportCanonicalThreadMemories)...)
			_memories0.POST("/import", append(_importcanonicalthreadmemoriesMw(), coze.ImportCanonicalThreadMemories)...)
			_memories0.DELETE("/:memory_id", append(_deletecanonicalthreadmemoryMw(), coze.DeleteCanonicalThreadMemory)...)
			_memory_id0 := _memories0.Group("/:memory_id", _memory_id0Mw()...)
			_memory_id0.POST("/restore", append(_restorecanonicalthreadmemoryMw(), coze.RestoreCanonicalThreadMemory)...)
			_memories0.PUT("/:memory_id", append(_updatecanonicalthreadmemoryMw(), coze.UpdateCanonicalThreadMemory)...)
			_thread_id0.GET("/messages", append(_listcanonicalthreadmessagesMw(), coze.ListCanonicalThreadMessages)...)
			_thread_id0.POST("/messages", append(_appendcanonicalthreadmessageMw(), coze.AppendCanonicalThreadMessage)...)
			...
			_run_id0.POST("/retry", append(_retrycanonicalsubagentrunMw(), coze.RetryCanonicalSubagentRun)...)
			...
			_thread_id0.POST("/suggestions", append(_generatecanonicalthreadsuggestionsMw(), coze.GenerateCanonicalThreadSuggestions)...)
			_thread_id0.GET("/token_usage", append(_getcanonicalthreadtokenusageMw(), coze.GetCanonicalThreadTokenUsage)...)
			_thread_id0.GET("/uploads", append(_listcanonicalthreaduploadsMw(), coze.ListCanonicalThreadUploads)...)
			_uploads := _thread_id0.Group("/uploads", _uploadsMw()...)
			_uploads.DELETE("/:file_id", append(_deletecanonicalthreaduploadMw(), coze.DeleteCanonicalThreadUpload)...)
			_thread_id0.POST("/uploads", append(_uploadcanonicalthreadfilesMw(), coze.UploadCanonicalThreadFiles)...)
